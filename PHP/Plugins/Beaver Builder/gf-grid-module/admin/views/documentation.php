...
<div class="livemesh-doc">
    ...
    <div class="intro-wrap">
        ...
        <div class="intro">
            <h3><?php printf(__('Getting started with %1$s v%2$s', 'gf-grid-module'), $plugin['Name'], $plugin['Version']); ?></h3>

            <h4><?php printf(__('Thanks for installing %1$s! We truly appreciate the support and the opportunity to share our work with you. Please visit the tabs below to get started on using our plugin to build your site!', 'gf-grid-module'), $plugin['Name']); ?></h4>
        </div>
    ...
    <div class="panels">
        <ul class="inline-list">
            <li class="current"><a id="help" href="#"><span
                            class="dashicons dashicons-yes"></span> <?php _e('Help File', 'gf-grid-module'); ?></a>
            </li>
            <li><a id="plugins" href="#"><span
                            class="dashicons dashicons-admin-plugins"></span> <?php _e('Plugins', 'gf-grid-module'); ?>
                </a>
            </li>
            <li><a id="support" href="#"><span
                            class="dashicons dashicons-editor-help"></span> <?php _e('FAQ &amp; Support', 'gf-grid-module'); ?>
                </a>
            </li>
            <li><a id="updates" href="#"><span
                            class="dashicons dashicons-update"></span> <?php _e('Latest Updates', 'gf-grid-module'); ?>
                </a>
            </li>
        </ul>
        ...
        <div id="panel" class="panel">
            ...
            <div id="help-panel" class="panel-left visible">
                ...
                <ol>
                    ...
                    <li>Once the plugin is activated, all of the elements part of the plugin are available in frontend Beaver
                        ...
                        <p>Once you are done with developing the site, for performance gains, you can selectively deactivate
                            ...
                            <strong> <a href="<?php echo admin_url() . 'options-general.php?page=fl-builder-settings#modules'; ?>"
                                        target="_blank"><?php echo __('Settings->Page Builder', 'gf-grid-module') ?></a></strong>
                    ...
                    <li>Optionally, if you have <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin installed, you can import the sample data
                        ...
                        <strong> <a href="<?php echo admin_url() . 'import.php'; ?>"
                                    target="_blank"><?php echo __('Tools→Import', 'gf-grid-module') ?></a></strong>
                        in WordPress admin.
                    </li>
                </ol>
                ...
                <p>The demo site <strong>sample-data.xml</strong> file is located in the plugin directory created after unzipping the premium bundle. Once you have access to the sample data file, you can install the demo site by visiting <strong> <a href="<?php echo admin_url() . 'import.php'; ?>" target="_blank"><?php echo __('Tools→Import', 'gf-grid-module') ?></a></strong> and click Choose File. Upload the xml file and follow the steps to
                ...
                <ul>
                    ...
                    <li>Once the Addons for Beaver Builder plugin is activated, you should see a menu item <strong> <a href="<?php echo admin_url() . 'admin.php?page=livemesh_bb_addons'; ?>"
                                                                                                                        target="_blank"><?php echo __('Beaver Addons', 'gf-grid-module') ?></a></strong> in WordPress admin with four sections - Settings, Custom CSS, Debugging and Premium Upgrade.
                        ...
                        <p>The settings screen <strong> <a href="<?php echo admin_url() . 'admin.php?page=livemesh_bb_addons'; ?>"
                                                           target="_blank"><?php echo __('Beaver Addons→Settings', 'gf-grid-module') ?></a></strong> for the plugin is self-documenting with minimal
                ...
                <ul>
                    ...
                    <li><strong>Pricing Plan Details</strong> – Enter the content for the pricing plan that include information
                        ...
                        [gf_pricing_item title="Storage Space" value="50 GB"]
                        [gf_pricing_item title="Video Uploads" value="50"]
                        [gf_pricing_item title="Portfolio Items" value="20"].
            ...
            <div id="plugins-panel" class="panel-left">
                ...
                <h4><?php _e('Beaver Builder', 'gf-grid-module'); ?>
                    <?php if (!class_exists('FLBuilder')) { ?>
                        <a class="button button-secondary thickbox onclick" href="<?php echo esc_url($beaverBuilderUrl); ?>"
                           title="<?php esc_attr_e('Install Beaver Builder', 'gf-grid-module'); ?>"><span
                                    class="dashicons dashicons-download"></span> <?php _e('Install Now', 'gf-grid-module'); ?></a>
                    <?php }
                    else { ?>
                        <span class="button button-secondary disabled"><span
                                    class="dashicons dashicons-yes"></span> <?php _e('Installed', 'gf-grid-module'); ?></span>
                    <?php } ?>
                </h4>
                ...
                <h4><?php _e('Portfolio Post Type', 'gf-grid-module'); ?>
                    <?php if (!class_exists('Portfolio_Post_Type')) { ?>
                        <a class="button button-secondary thickbox onclick" href="<?php echo esc_url($portfolioPostTypeUrl); ?>"
                           title="<?php esc_attr_e('Install Portfolio Post Type', 'gf-grid-module'); ?>"><span
                                    class="dashicons dashicons-download"></span> <?php _e('Install Now', 'gf-grid-module'); ?></a>
                    <?php }
                    else { ?>
                        <span class="button button-secondary disabled"><span
            ...
            <div id="support-panel" class="panel-left">
                ...
                <p>In Beaver Builder page builder, add a row wrapper for the element, edit row and navigate to the 'Advanced'
                    ...
                    class ‘gf-dark-bg’ in the 'Class' field to activate the dark version of an element.</p>
            ...
            <div class="panel-right">
                ...
                <div class="panel-inner">
                    ...
                    <div class="panel-aside">
                        <h4><?php _e('Why upgrade to Premium version?', 'gf-grid-module'); ?></h4>
                        <p><?php _e('Premium version offers multiple benefits - more addon elements, advanced features for addons including those part of the free plugin and priority support through a dedicated support forum.', 'gf-grid-module'); ?></p>

                        <a class="button button-primary"
                           href="<?php echo admin_url() . 'admin.php?page=livemesh_bb_addons_pro_upgrade'; ?>"
                           title="<?php esc_attr_e('Know More', 'gf-grid-module'); ?>"><?php _e('Know More Details', 'gf-grid-module'); ?></a>
