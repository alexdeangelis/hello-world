.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-load-more {
    background: <?php echo $module->get_theme_color(); ?>;
    }
.fl-node-<?php echo $id; ?> .gf-portfolio {
...
.fl-node-<?php echo $id; ?> .gf-portfolio .gf-portfolio-item {
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-heading {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-taxonomy-filter .gf-filter-item a {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-taxonomy-filter .gf-filter-item a:hover, .fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-taxonomy-filter .gf-filter-item.gf-active a {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-taxonomy-filter .gf-filter-item.gf-active a {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-project-image .gf-image-info .gf-post-title {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-project-image .gf-image-info .gf-post-title a {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-project-image .gf-image-info .gf-post-title a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-project-image .gf-image-info .gf-terms a {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-project-image .gf-image-info .gf-terms a:hover {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .entry-title {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .entry-title a {
<?php
    if( !empty( $settings->entry_title_color ) ) {
        echo 'color: #'. $settings->entry_title_color .';';
    }
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .entry-summary {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-entry-meta span {
<?php
...
.fl-node-<?php echo $id; ?> .gf-portfolio-wrap .gf-portfolio .gf-portfolio-item .gf-entry-meta span a {
<?php
